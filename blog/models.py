...
class Blog(models.Model):
    user = models.ForeignKey(Account, related_name="user_blogs", on_delete=models.CASCADE)
    ...
    likes = models.ManyToManyField(Account, related_name="user_likes", blank=True)
    title = models.CharField(max_length=255, unique=True)
...
class Comment(models.Model):
    user = models.ForeignKey(Account, related_name="user_comments", on_delete=models.CASCADE)
...
class Reply(models.Model):
    user = models.ForeignKey(Account, related_name="user_replies", on_delete=models.CASCADE)
